...
_axios.default.defaults.headers.common = {
  'Authorization': "Bearer ".concat(document.cookie.split('cookie1=')[1])
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success' || res.status === 200) {
              (0, _alerts.showAlert)('success', 'Signed in!');
...
var logout = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(flag, us, pw) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            _context2.prev = 8;
            _axios.default.defaults.headers.common = {
              'Authorization': "Bearer loggedout"
            };
          ...
          case 20:
            (0, _alerts.showAlert)('success', 'See you soon again?');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          ...
          case 24:
            ...
            console.log(_context2.t1.response);
            (0, _alerts.showAlert)('error', 'Greška pri odjavi. Probajte ponovo.');
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 13:
            ...
            if (_res.data.status === 'success' || _res.status === 200) {
              (0, _alerts.showAlert)('success', 'Uspješno registrovani!');

              if (_res.data.accessToken) {
                setCookie('jwt', _res.data.accessToken, 90);
              }
...
var signupForm = document.querySelector('.button--register');
...
if (signupForm) signupForm.addEventListener('click', function (e) {
  e.preventDefault();
  var user = new Object();
